...
export const routes: Routes = [
  ...
  { path: 'client-home', component: ClientHomeComponent, canActivate: [AuthGuard], data: { roles: ['CLIENTE'] }},
  { path: 'deposit', component: DepositComponent, canActivate: [AuthGuard], data: { roles: ['CLIENTE'] } },
  { path: 'withdraw', component: WithdrawComponent, canActivate: [AuthGuard], data: { roles: ['CLIENTE'] } },
  { path: 'transfer', component: TransferComponent, canActivate: [AuthGuard], data: { roles: ['CLIENTE'] } },
  { path: 'update-profile', component: UpdateProfileComponent, canActivate: [AuthGuard], data: { roles: ['CLIENTE'] } },
  { path: 'manager-home', component: ManagerHomeComponent, canActivate: [AuthGuard], data: { roles: ['GERENTE'] }},
  { path: 'transaction-history', component: TransactionHistoryComponent, canActivate: [AuthGuard], data: { roles: ['CLIENTE'] } },
  { path: 'administrator-home', component: AdministratorHomeComponent, canActivate: [AuthGuard], data: { roles: ['ADMINISTRADOR'] }},
  { path: 'list-manager', component: ListManagerComponent, canActivate: [AuthGuard], data: { roles: ['ADMINISTRADOR'] } },
  { path: 'manager-client-list', component: ManagerListaClientesComponent, canActivate: [AuthGuard], data: { roles: ['GERENTE'] } },
  { path: 'manager-client-details/:cpf', component: ManagerClientDetailsComponent, canActivate: [AuthGuard], data: { roles: ['MANAGER'] } },
  { path: 'top-clients', component: TopClientsComponent, canActivate: [AuthGuard], data: { roles: ['GERENTE'] } },
  { path: 'search-client', component: ClientSearchComponent,canActivate: [AuthGuard], data: { roles: ['GERENTE'] }},
  { path: 'administrator-client-list', component: AdministratorListaClientesComponent, canActivate: [AuthGuard], data: { roles: ['ADMINISTRADOR'] }}
];
